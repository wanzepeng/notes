...
channel是读写数据的**双向通道**，可以从channel将数据读入buffer，也可将buffer的数据写入channel。
...
可通过输入输出流或RandomAccessFile获取FileChannel。



```java
// 使用try-resources语句时，try代码块执行完毕之后会自动执行is.close()
...
可以使用allocate方法为ByteBuffer分配空间，其它buffer类也有类似方法

```java
// class java.nio.HeapByteBuffer - java 使用堆内存，读写效率较低，收到垃圾回收的影响
Bytebuffer buf = Bytebuffer.allocate(32);
// class java.nio.DirectByteBuffer - 直接内存 读写效率高（少一次拷贝），不会受到垃圾回收的影响，分配的效率低
...
- 调用channel的write方法
  ...
  ```java
  int writeBytes = channel.wirte(buf);
  ```
...
- 调用buffer自己的get方法
  ...
  - 调用get(int i)方法获取索引i的内容，不会移动读指针
...
SocketChannel传输的数据是有限的，不能保证一次把所有数据写入，所以多次调用write将数据写完。
...
![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0023.png)
...
![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0033.png)

* 阻塞 IO

  ![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0039.png)

* 非阻塞  IO

  ![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0035.png)

* 多路复用

  ![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0038.png)

* 信号驱动

* 异步 IO

  ![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0037.png)

* 阻塞 IO vs 多路复用

  ![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0034.png)

  ![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0036.png)
...
![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0024.png)
...
![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0025.png)
...
![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0026.png)
...
![](D:/学习/后端/Netty网络编程/讲义/Netty-讲义/img/0027.png)
